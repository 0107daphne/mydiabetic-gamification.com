...
<div class="container">
    <h3 class="text-center">Running Ron (Medium Humanlike ver.)</h3>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <iframe src = "http://running-ron-medium-humanlike.mydiabetic-gamification.com/" height = "720" width="1000"></iframe>
        </div>
    </div>
