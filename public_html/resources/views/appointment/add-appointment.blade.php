    ...
    <div class='container'>
        <div class="create-task col-lg-12">
            <div class="modal-header" style='background:mediumseagreen;'>
                <h4 class="modal-title text-center" style='color:white;'>ADD APPOINTMENT</h4>
                <a href="/appointment" class="btn" style=" color:white;" aria-label="Cancel Edit"><i class='fas fa-times'
