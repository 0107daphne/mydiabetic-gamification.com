...
@section('title', 'MyDiabetics | Badge')
    ...
    <div class="container-fluid">
        ...
        <div class="create-task col-lg-12">
            <div class="modal-header">
                <h4 class="modal-title text-center text-dark">BADGES</h4>
            </div>
            <br>
            <p><small>These are the badges that you can earn if you complete your appointments:</small></p>
            <br>
